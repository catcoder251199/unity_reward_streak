...
{
    public class RewardStreakRewardItem : MonoBehaviour
    {
        ...
        = new()
        {
            {RewardStreakConstants.Gold, 0},
            {RewardStreakConstants.Refresh, 1},
            {RewardStreakConstants.Clear, 2},
            {RewardStreakConstants.Sort, 3},
        };
