...
public class GameMaster : MonoBehaviour
{
    ...
    public async UniTaskVoid ShowRewardedVideo(Action onWatchAdSuccess, Action<string> onWatchAdFailed, string adPlacement)
    {
        ...
        else
        {
            ...
            //onWatchAdFailed("UI_NO_INTERNET");
            onWatchAdFailed("UI_REWARD_NOT_AVAILABLE");
        }
    }
}
