...
public class UserProfile : ScriptableObject
{
    ...
    public RewardStreakUserData RewardStreakUserData
    {
        get
        {
            if (profile.rewardStreakUserData == null)
            {
                profile.rewardStreakUserData = new RewardStreakUserData();
                isDirty = true;
            }
            
            return profile.rewardStreakUserData;
        }
    }
}
